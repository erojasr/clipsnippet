...
--
-- Table structure for table `snippet_subcategories`
--
...
--
-- Dumping data for table `snippet_subcategories`
--

LOCK TABLES `snippet_subcategories` WRITE;
/*!40000 ALTER TABLE `snippet_subcategories` DISABLE KEYS */;
/*!40000 ALTER TABLE `snippet_subcategories` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-09-12 18:44:49
